...
namespace Chat.Application.Handlers.Commands.Auth
{
    public class AuthenticateHandler : BaseCommandHandler<AuthenticateRequest, BaseResponse<TokenResponse>>
    {
        ...
        public AuthenticateHandler(IEnumerable<IValidator<AuthenticateRequest>> validators, ILogger logger, IMapper mapper, DataBaseContext dbContext, ITokenService tokenService) : base(validators, logger, mapper)
        {
